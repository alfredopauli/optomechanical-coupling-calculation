...
Vec3 Triangle::GetPoint(short index) const
{
...
{
    return 1.0/2.0 * (Vec3::Cross(m_points[1] - m_points[0], m_points[2] - m_points[0])).Magnitude();
}

Vec3 Triangle::GetMidpoint() const
{
...
void Triangle::Subdivide(Triangle triangle, Triangle new_triangles[4])
{
